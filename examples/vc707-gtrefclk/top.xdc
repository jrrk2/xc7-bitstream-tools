# VC707 SGMIICLK, the board's 125 MHz gigabit-transceiver reference clock.
set_property LOC AH8 [get_ports sgmii_refclk_p]
set_property LOC AH7 [get_ports sgmii_refclk_n]
